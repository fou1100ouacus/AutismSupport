...
// إعدادات الداتابيز المتوافقة مع السيرفر المشترك والمحلي
builder.Services.AddDbContext<ApplicationDBContext>(option =>
{
    var connectionString = builder.Configuration.GetConnectionString("dbcontext");
...
app.UseSwaggerUI(c =>
{
    // أضفنا نقطة قبل المسار ليفهم الـ IIS أونلاين مكانه بدقة
    c.SwaggerEndpoint("./v1/swagger.json", "Autism Project API V1");
    
    // أعدنا الـ RoutePrefix إلى الافتراضي "swagger" ليتعرف عليه السيرفر دون تعارض 403
