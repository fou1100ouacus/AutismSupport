...
//             int totalScore = 0;
//             int maxPossibleScore = dbQuestions.Count() * 2; // لو أعلى درجة لكل سؤال هي 2

//             foreach (var group in categoryGroups)
//             {
//                 string categoryName = group.Key;
//                 // جلب الـ IDs الخاصة بأسئلة هذا القسم
...
//                 // 🔥 تعديل هندسي منطقي: حساب النسبة المئوية الخاصة بهذا القسم بالتحديد بدلاً من رقم ثابت
//                 int maxCategoryScore = group.Count() * 2;
...
//             double totalPercentage = ((double)totalScore / maxPossibleScore) * 100;
